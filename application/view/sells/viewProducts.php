            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="<?php echo URL;?>productController/viewProducts">Home</a></li>
                    ...
                    <form class="d-flex">
                    <a href="<?php echo URL; ?>productController/shopCar">
                        ...
                        <div class="col mb-5">
                            <div class="card h-100">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="<?php echo URL;?>productController/shopCar">View Product</a></div>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
